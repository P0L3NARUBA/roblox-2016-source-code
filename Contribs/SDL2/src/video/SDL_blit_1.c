...
static const SDL_BlitFunc one_blit[] = {
    (SDL_BlitFunc) nullptr, Blit1to1, Blit1to2, Blit1to3, Blit1to4
};

static const SDL_BlitFunc one_blitkey[] = {
    (SDL_BlitFunc) nullptr, Blit1to1Key, Blit1to2Key, Blit1to3Key, Blit1to4Key
};
...
SDL_CalculateBlit1(SDL_Surface * surface)
{
    ...
    case SDL_COPY_MODULATE_ALPHA | SDL_COPY_BLEND:
        ...
        return which >= 2 ? Blit1toNAlpha : (SDL_BlitFunc) nullptr;

    case SDL_COPY_COLORKEY | SDL_COPY_MODULATE_ALPHA | SDL_COPY_BLEND:
        return which >= 2 ? Blit1toNAlphaKey : (SDL_BlitFunc) nullptr;
    }
