...
{
  RegCoreObjType(OTEXT,       /*"Text"*/     "1GFR",       sizeof(GEO_TEXT),    OLD_OTEXT,       nullptr,     TRUE);
	...
	RegCoreObjType(OPATH,     /*  "Path"*/   "JRYE",       sizeof(GEO_PATH),    OLD_OPATH,       nullptr,     FALSE);
	RegCoreObjType(OBREP,     /*  "BRep"*/   "QNRE",       sizeof(GEO_BREP),    OLD_OBREP,       &EBREP,   FALSE);
	RegCoreObjType(OGROUP,    /*  "Group"*/  "PPEOR",      sizeof(GEO_GROUP),   OLD_OGROUP,      nullptr,     FALSE);
	RegCoreObjType(ODIM,      /*  "Dim"*/    "EMT",        sizeof(GEO_DIM),     OLD_ODIM,        nullptr,     TRUE);
	RegCoreObjType(OINSERT,   /*  "Insert"*/ "NTYREW",     sizeof(GEO_INSERT),  OLD_OINSERT,     nullptr,     FALSE);
	RegCoreObjType(OSPLINE,   /*  "Spline"*/ "QOREEE",     sizeof(GEO_SPLINE),  OLD_OSPLINE,     &ESPLINE, TRUE);
	RegCoreObjType(OFRAME,   /*   "Frame"*/  "*H4F46",      sizeof(GEO_FRAME),   OLD_OFRAME,      nullptr,     FALSE);
}
