...
namespace RBX {
	...
	namespace Reflection {
		template<>
		EnumDesc<TonemapperMode>::EnumDesc()
			:EnumDescriptor("Tonemapper")
		{
			addPair(LEGACY, "Legacy");
			addPair(REINHARD, "Reinhard");
			addPair(ACES, "ACES");
			addPair(PBR_NEUTRAL, "PBR Neutral");
			addPair(AGX, "AgX");
		}
	}
	...
	Reflection::EnumPropDescriptor<Lighting, TonemapperMode> Lighting::prop_CameraTonemapper("Tonemapper", "Camera", &Lighting::getCameraTonemapper, &setCameraTonemapper);

	/* Deprecated */
	Reflection::PropDescriptor<Lighting, G3D::Color3> Lighting::prop_TopColorShift_deprecated("ColorShift_Top", category_Appearance, &Lighting::getTopColorShift_deprecated, &Lighting::setTopColorShift_deprecated, Reflection::PropertyDescriptor::Attributes::deprecated(prop_SunColorShift, Reflection::PropertyDescriptor::LEGACY_SCRIPTING));
	Reflection::PropDescriptor<Lighting, G3D::Color3> Lighting::prop_BottomColorShift_deprecated("ColorShift_Bottom", category_Appearance, &Lighting::getBottomColorShift_deprecated, &Lighting::setBottomColorShift_deprecated, Reflection::PropertyDescriptor::LEGACY_SCRIPTING);
	Reflection::PropDescriptor<Lighting, bool>		  Lighting::prop_GlobalShadows_deprecated("GlobalShadows", category_Appearance, &Lighting::getGlobalShadows_deprecated, &Lighting::setGlobalShadows_deprecated, Reflection::PropertyDescriptor::Attributes::deprecated(prop_GlobalShadows, Reflection::PropertyDescriptor::LEGACY_SCRIPTING));
	Reflection::PropDescriptor<Lighting, G3D::Color3> Lighting::prop_GlobalOutdoorAmbient_deprecated("OutdoorAmbient", category_Appearance, &Lighting::getGlobalOutdoorAmbient_deprecated, &Lighting::setGlobalOutdoorAmbient_deprecated, Reflection::PropertyDescriptor::Attributes::deprecated(prop_GlobalOutdoorAmbient, Reflection::PropertyDescriptor::LEGACY_SCRIPTING));
	Reflection::PropDescriptor<Lighting, bool>		  Lighting::prop_Outlines_deprecated("Outlines", category_Appearance, &Lighting::getOutlines_deprecated, &Lighting::setOutlines_deprecated, Reflection::PropertyDescriptor::LEGACY_SCRIPTING);
	Reflection::PropDescriptor<Lighting, G3D::Color3> Lighting::prop_ShadowColor_deprecated("ShadowColor", category_Appearance, &Lighting::getShadowColor_deprecated, &Lighting::setShadowColor_deprecated, Reflection::PropertyDescriptor::LEGACY_SCRIPTING);

	Reflection::PropDescriptor<Lighting, G3D::Color3> Lighting::prop_FogColor_deprecated("FogColor", "Fog", &Lighting::getFogColor_deprecated, &Lighting::setFogColor_deprecated, Reflection::PropertyDescriptor::LEGACY_SCRIPTING);
	Reflection::PropDescriptor<Lighting, float>		  Lighting::prop_FogStart_deprecated("FogStart", "Fog", &Lighting::getFogStart_deprecated, &Lighting::setFogStart_deprecated, Reflection::PropertyDescriptor::LEGACY_SCRIPTING);
	Reflection::PropDescriptor<Lighting, float>		  Lighting::prop_FogEnd_deprecated("FogEnd", "Fog", &Lighting::getFogEnd_deprecated, &Lighting::setFogEnd_deprecated, Reflection::PropertyDescriptor::LEGACY_SCRIPTING);
	...
	{
		skyParameters.lightColor = Color3(1.0f, 1.0f, 1.0f);
	...
	void Lighting::setCameraTonemapper(TonemapperMode value) {
		if (cameraTonemapper != value) {
			cameraTonemapper = value;
			this->raisePropertyChanged(prop_CameraTonemapper);
		}
	}
