...
namespace RBX {
	...
	protected:
		...
		size_t bulletManifoldIndex;
		size_t bulletPointCacheIndex;
	...
	public:
		...
		size_t getBulletManifoldIndex(void) const { return bulletManifoldIndex; }
		size_t getBulletPointCacheIndex(void) const { return bulletPointCacheIndex; }
