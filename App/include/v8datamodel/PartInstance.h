...
namespace RBX {
	...
	public:
		...
		virtual const Vector3& getMinimumUiSize() const { static Vector3 minSize(0.001f, 0.001f, 0.001f); return minSize; }
		virtual const Vector3& getMinimumUiSizeCustom() const { static Vector3 minSize(0.001f, 0.001f, 0.001f); return minSize; }
