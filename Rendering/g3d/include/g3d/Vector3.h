...
namespace G3D {
	...
	public:
		...
		*/
		...
		// Special values.
		static const Vector3& zero()	  { static const Vector3 v(0.0f, 0.0f, 0.0f); return v; }
		static const Vector3& one()		  { static const Vector3 v(1.0f, 1.0f, 1.0f); return v; }
		static const Vector3& normal()	  { static const Vector3 v(0.5f, 0.5f, 1.0f); return v; }
		static const Vector3& unitX()	  { static const Vector3 v(1.0f, 0.0f, 0.0f); return v; }
		static const Vector3& unitY()	  { static const Vector3 v(0.0f, 1.0f, 0.0f); return v; }
		static const Vector3& unitZ()	  { static const Vector3 v(0.0f, 0.0f, 1.0f); return v; }
