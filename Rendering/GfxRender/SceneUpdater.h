...
namespace RBX {
	namespace Graphics {
		...
		public:
			...
			uint32_t getLastLightingUpdates() const { return mLastLightingUpdates; }
			uint32_t getLightOldestAge();
			bool isLightingActive() const { return mLightingActive; }
		...
		private:
			...
			uint32_t mLastLightingUpdates;

			uint32_t mAgeDirtyProportion;
