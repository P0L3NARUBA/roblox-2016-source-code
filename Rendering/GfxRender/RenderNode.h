...
namespace RBX {
	namespace Graphics {
		...
		public:
			...
			static float computeViewDepth(const RenderCamera& camera, const Vector3& position, float offset = 0.0f);
		...
		public:
			RenderNode(VisualEngine* visualEngine, CullMode cullMode, uint32_t flags = 0u);
			virtual ~RenderNode();
